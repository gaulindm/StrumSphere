...
sopranoUkulele = [
	...
	'{define: Aaug frets 2 1 1 4 fingers 2 1 1 4}',
	'{define: Am6 frets 2 4 2 3 fingers 1 3 1 2}',
	'{define: A9 frets 0 1 0 2 fingers 0 1 0 2}',
	//  A# retruns Bb
	//  Bb
	// -------------------------------------------------------
	'{define: Bb frets 3 2 1 1 fingers 3 2 1 1}',
	'{define: Bbm frets 3 1 1 1 fingers 3 1 1 1}',
	'{define: Bb7 frets 1 2 1 1 fingers 1 2 1 1}',
	'{define: Bb7sus4 frets 1 3 1 1 fingers 1 3 1 1}',
	...
	'{define: Bbaug frets 3 2 2 5 fingers 2 1 1 4}',
	...
	'{define: B7sus4 frets 2 4 2 2 fingers 1 3 1 1}',
	...
	//  C#
	// -------------------------------------------------------
	'{define: C# frets 1 1 1 4 fingers 1 1 1 4}',
	'{define: C#m frets 1 4 4 4 fingers 1 2 3 3}',
	'{define: C#7 frets 1 1 1 2 fingers 1 1 1 2}',
	...
	'{define: C#maj7 frets 1 1 1 3 fingers 1 1 1 3}',
	...
	'{define: C#aug frets 2 1 1 4 fingers 2 1 1 4}',
	...
	'{define: Dmaj7 frets 2 2 2 4 fingers 1 1 1 2}',
	...
	'{define: Daug frets 3 2 2 5 fingers 2 1 1 4}',
	...
	'{define: Eb7 frets 3 3 3 4 fingers 1 1 1 2}',
	...
	'{define: Ebmaj7 frets 3 3 3 5 fingers 1 1 1 2}',
	...
	'{define: Fm6 frets 1 2 1 3 fingers 1 2 1 3}',
	...
	'{define: F6aug frets 2 1 1 4 fingers 2 1 1 4}',
	'{define: F9 frets 2 3 3 3}',
	'{define: Faug frets 2 1 1 0 fingers 3 1 2 0}',
	//  F#
	// -------------------------------------------------------
	'{define: F# frets 3 1 2 1 fingers 3 1 2 1}',
	...
	'{define: F#aug frets 3 2 2 5 fingers 2 1 1 4}',
	...
	//  G#
	// -------------------------------------------------------
	'{define: G# frets 5 3 4 3 fingers 3 1 2 1}',
	...
	'{define: G#m6 frets 1 3 1 2 fingers 1 3 1 2}',
